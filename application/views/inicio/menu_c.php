...
<head>
	...
	<title>Plataforma de gestion de los tickets de almuerzo - UNICA</title>
</head>
<body>
...
<table width="100%" cellpadding="3" cellspacing="0">
    <thead>
        <tr>
            <td align="center" style="font-size: 1.2em;">Comida</td>
        </tr>
    </thead>
</table>    
            ...
            if(count($menu_hoy) < 1){
                ...
                for ($i=0; $i < count($menu_hoy); $i++) {
                    ...
                    $precio_hoy += $plato['precio'];
                        echo '<tr><td valign="top"><div class="texto_plato" style="display: flex;>'.$plato['nombreplato_comida'].' '.$plato['cantidad'].' '.$plato['simbolo'].' </td><td valign="top"><div style="padding:0 3px; float: right;">$'.number_format($plato['precio'], 2) .'</div></div></td></tr>';
                }
            }
        ?>
    <thead>
